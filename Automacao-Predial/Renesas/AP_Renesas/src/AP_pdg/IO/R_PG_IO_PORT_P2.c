...
bool R_PG_IO_PORT_Set_P2(void)
{
	...
	res = R_IO_PORT_Set(
		PDL_IO_PORT_2_1,
		PDL_IO_PORT_OUTPUT | PDL_IO_PORT_INPUT_BUFFER_OFF | PDL_IO_PORT_CMOS
	);
...
* Include      : 
*
* Declaration  : bool R_PG_IO_PORT_Set_P21(void)
*
* Function Name: R_PG_IO_PORT_Set_P21
*
* Description  : Set up the I/O port pin
*
* Arguments    : None
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_IO_PORT_Set_P21(void)
{
	return R_IO_PORT_Set(
		PDL_IO_PORT_2_1,
		PDL_IO_PORT_OUTPUT | PDL_IO_PORT_INPUT_BUFFER_OFF | PDL_IO_PORT_CMOS
...
* Include      : 
*
* Declaration  : bool R_PG_IO_PORT_Write_P21(uint8_t data)
*
* Function Name: R_PG_IO_PORT_Write_P21
*
* Description  : Write 1-bit data to the I/O port data register
*
* Arguments    : uint8_t data : Value to be written.
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_IO_PORT_Write_P21(uint8_t data)
{
	return R_IO_PORT_Write(
		PDL_IO_PORT_2_1,
		data
...
* Include      : 
*
* Declaration  : bool R_PG_IO_PORT_Write_P26(uint8_t data)
*
* Function Name: R_PG_IO_PORT_Write_P26
*
* Description  : Write 1-bit data to the I/O port data register
*
* Arguments    : uint8_t data : Value to be written.
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_IO_PORT_Write_P26(uint8_t data)
{
	return R_IO_PORT_Write(
		PDL_IO_PORT_2_6,
		data
