...
/* Data clock source */
#define PDL_SCI_CLK_INT_IO		0x00080000ul
#define PDL_SCI_CLK_TMR			0x00100000ul
...
#define PDL_SCI_RX_CONTINUOUS_DISABLE 		0x0010u
#define PDL_SCI_RX_CONTINUOUS_ENABLE		0x0020u
